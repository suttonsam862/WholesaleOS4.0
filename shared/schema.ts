...
export const invoices = pgTable("invoices", {
  ...
  orgId: integer("org_id").references(() => organizations.id),
  salespersonId: varchar("salesperson_id").references(() => users.id),
  revenueSource: varchar("revenue_source").$type<"order" | "team_store" | "other">().default("order"),
...
export const insertInvoiceSchema = createInsertSchema(invoices, {
  ...
  revenueSource: z.enum(["order", "team_store", "other"]).optional(),
  teamStoreId: z.number().int().positive().optional().nullable(),
